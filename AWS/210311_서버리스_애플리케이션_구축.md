...
- `zip -r Lambda-Deployment.zip * -x *.zip *.log` : 하위 디렉터리를 포함하여(-r) Lambda-Deployment.zip 파일로 압축하되 zip, log 파일은 제외
...
배포가 완료되면 람다 페이지에서 확인 가능 -> 배포 패키지가 커서 보이지 않는다

![image](https://user-images.githubusercontent.com/77096463/110747012-0b7c0000-8281-11eb-953a-2d7c7f74a7a4.png)