...
```
ubuntu@ip-172-31-19-242:~/yaml_files$ ssh 3.219.215.240

ubuntu@ip-172-20-34-254:~$ 
```
...
NAME                                  READY   STATUS    RESTARTS   AGE     IP           NODE                           NOMINATED NODE   READINESS GATES
my-user-deployment-7cbc8995c6-964zv   1/1     Running   0          6m42s   100.96.3.3   ip-172-20-32-19.ec2.internal   <none>           <none>

ubuntu@ip-172-20-34-254:~$ curl 100.96.3.3:8080/users
...
![service](https://user-images.githubusercontent.com/77096463/112233394-bc20d100-8c7d-11eb-9cc1-c8c3c5611954.PNG)
